<template>
    <div class="users-container">
        ...
        <el-row class="users-box">
            ...
            <!-- 表格展示 -->
            <el-col :sm="24" :lg="24">
                <el-table :data="essaylist" border stripe style="width: 100%">
                    <!-- <el-table-column prop="_id" label="文章id" width="0">
                    </el-table-column> -->
                    <el-table-column prop="title" label="标题" width="0">
                    </el-table-column>
                    <!-- <el-table-column show-overflow-tooltip prop="content" label="文章内容" width="0">
                    </el-table-column> -->
                    <el-table-column prop="creater" label="作者" width="180">
                    </el-table-column>
